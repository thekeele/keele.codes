defmodule KeeleCodes.PromEx do
  @moduledoc """
  ...
  1. Update your configuration (config.exs, dev.exs, prod.exs, releases.exs, etc) to
     ...
     ```
     config :keele_codes, KeeleCodes.PromEx,
       disabled: false,
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule KeeleCodesWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :keele_codes

       ...

       plug PromEx.Plug, prom_ex_module: KeeleCodes.PromEx
  ...
  use PromEx, otp_app: :keele_codes
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: KeeleCodesWeb.Router, endpoint: KeeleCodesWeb.Endpoint},
      Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboards do
    [
      ...
      # {:keele_codes, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
